...
/******/ 	return __webpack_require__(__webpack_require__.s = "./ts/admin.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var tide_1 = __webpack_require__(/*! ./modules/tide */ "./ts/modules/tide.ts");
$(function () {
    // 休日カレンダー
...
exports.Tide = void 0;
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var Tide = /** @class */ (function () {
    function Tide(ajaxing) {
        ...
        $(document).on('click', '.trigGetTideData', function () {
            ...
            var placeCode = $(this).attr('data-place');
            self.ajaxGetTideData(year, placeCode);
        });
    }
    // 年とエリアの潮位データを国交省サイトから取得
    Tide.prototype.ajaxGetTideData = function (year, placeCode) {
        var self = this;
        self.ajaxing = true;
        var token = $('meta[name="csrf-token"]').attr('content');
        var D = { year: year, place_code: placeCode };
        $.ajax({
