...
/******/ 	return __webpack_require__(__webpack_require__.s = "./ts/script.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/cal.js/dist/cal.min.js":
/*!*********************************************!*\
  !*** ./node_modules/cal.js/dist/cal.min.js ***!
  \*********************************************/
...
module.exports = __webpack_require__(/*! ./dist/cal.min.js */ "./node_modules/cal.js/dist/cal.min.js");
...
Object.defineProperty(exports, "__esModule", { value: true });
var func_1 = __webpack_require__(/*! ./func */ "./ts/func.ts");
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var calJS = __webpack_require__(/*! cal.js */ "./node_modules/cal.js/index.js");
var Calendar;
(function (Calendar) {
    var MyCalendar = /** @class */ (function () {
        function MyCalendar(calendar) {
            ...
            $('.trigShowCalendar input').keyup(function () {
                var vals = self.getDateInputs($(this));
                self.year = vals.year;
...
var Func = /** @class */ (function () {
    ...
    Func.smoothScroll = function (target, flagAnimation) {
...
var GoogleMap;
(function (GoogleMap) {
    var MyGoogleMap = /** @class */ (function () {
        function MyGoogleMap(skin, places, markers, infoWindows) {
            if (skin === void 0) { skin = 'dark'; }
            if (places === void 0) { places = {}; }
            if (markers === void 0) { markers = []; }
            if (infoWindows === void 0) { infoWindows = []; }
            this.skin = skin;
            this.places = places;
            this.markers = markers;
            this.infoWindows = infoWindows;
            this.mapPosition = { lat: 34.65, lng: 134.98333333333332 };
            this.lightStyle = [];
            this.darkStyle = [
                {
        ...
        MyGoogleMap.prototype.setSkin = function (skin) {
            this.skin = skin;
        };
        MyGoogleMap.prototype.getPlaceDatas = function () {
            var places = $('#paramGoogleMap').data('places');
            for (var key in places) {
                var place = places[key];
                this.places[place.place_id] = place;
            }
        };
        MyGoogleMap.prototype.getLatLng = function () {
            this.mapPosition = {
                lat: $('#paramGoogleMap').data('lat'),
                lng: $('#paramGoogleMap').data('lng'),
            };
        };
        MyGoogleMap.prototype.initMap = function () {
            var self = this;
            var mapArea = document.getElementById('bulletGoogleMap');
            var style = self.darkStyle;
            if (self.skin == 'light') {
            ...
            var map = new self.google.maps.Map(mapArea, mapOptions);
            var _loop_1 = function (key) {
                var place = this_1.places[key];
                this_1.addMarker(place, key, self.google, map);
                this_1.addInfoWindow(place, key, self.google);
                this_1.markers[key].addListener('click', function () {
        ...
        MyGoogleMap.prototype.addMarker = function (place, key, google, map) {
            var markerOptions = {
                map: map,
        ...
        MyGoogleMap.prototype.addInfoWindow = function (place, key, google) {
    ...
    GoogleMap.MyGoogleMap = MyGoogleMap;
})(GoogleMap || (GoogleMap = {}));
    ...
    var calendar = /** @class */ (function () {
        ...
        calendar.prototype.setHoliday = function () {
            if ($(this.el).attr("data-thismonth") === "1") {
                var flag = $(this.el).attr("data-holiday");
                var dataHoliday = "";
                if (flag === "") {
                    dataHoliday = "both";
                }
        ...
        calendar.prototype.setWeeks = function () {
            var flag = $(this.el).data("flag");
            var wnum = $('#select-summary').val();
...
Object.defineProperty(exports, "__esModule", { value: true });
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var holiday_1 = __webpack_require__(/*! ./holiday */ "./ts/holiday.ts");
var calendar_1 = __webpack_require__(/*! ./calendar */ "./ts/calendar.ts");
var upload_1 = __webpack_require__(/*! ./upload */ "./ts/upload.ts");
var googlemap_1 = __webpack_require__(/*! ./googlemap */ "./ts/googlemap.ts");
var search_1 = __webpack_require__(/*! ./search */ "./ts/search.ts");
$(function () {
    //    Func.hoge();
    // 休日カレンダー
    var HOLIDAY = new holiday_1.default.calendar();
    // カレンダー
    var CALENDAR = new calendar_1.default.MyCalendar();
    // ドラッグでアップロード
    var UPLOAD = new upload_1.default.MyUpload();
    var GOOGLEMAP = new googlemap_1.default.MyGoogleMap();
    var SEARCH = new search_1.default.MySearch(GOOGLEMAP);
});
...
var Search;
(function (Search) {
    var MySearch = /** @class */ (function () {
        function MySearch(GoogleMap, ajaxing) {
            ...
            $('#trigChangeSkin').click(function () {
                var currentSkin = $(this).attr('data-skin');
        ...
        MySearch.prototype.getNextSkin = function (currentSkin) {
            var skin = '';
            if (currentSkin == 'dark') {
                skin = 'light';
            }
        ...
        MySearch.prototype.changeSkin = function (currentSkin) {
            var skin = this.getNextSkin(currentSkin);
            $('#trigChangeSkin').attr("data-skin", skin);
            var stylesheet = $('#bulletChangeSkin').attr('href');
         ...
         * @return boolean
         */
        MySearch.prototype.selectWeek = function (elm) {
            $('.trigSelectWeek').removeClass('selected');
            elm.addClass('selected');
            var week = elm.data('week');
            $('#bulletSelectWeek').val(week);
        };
        // エリアから地点選択肢入れ替え
        MySearch.prototype.changeSelectPlaceOptions = function (areaId) {
            var self = this;
            self.ajaxing = true;
            var token = $('meta[name="csrf-token"]').attr('content');
            var D = { area_id: areaId };
            $.ajax({
        ...
        // Skin の Session を更新
        MySearch.prototype.ajaxChangeSkin = function (skin) {
            var self = this;
            self.ajaxing = true;
            var token = $('meta[name="csrf-token"]').attr('content');
            var D = { skin: skin };
...
(function (Upload) {
    var MyUpload = /** @class */ (function () {
        function MyUpload(ajaxing, uploadable) {
            if (ajaxing === void 0) { ajaxing = false; }
            if (uploadable === void 0) { uploadable = false; }
            this.ajaxing = ajaxing;
            this.uploadable = uploadable;
            this.uploadSizeLimitImage = 15000000;
            this.uploadSizeLimitZip = 1000000000;
            this.uploadSizeLimitFree = 1000000000;
            this.enableExtensionsImage = ['jpg', 'jpeg', 'gif', 'png'];
            this.enableExtensionsZip = ['zip'];
            this.enableExtensionsFree = ['jpg', 'jpeg', 'gif', 'png', 'zip', 'rar', 'ai', 'eps', 'pdf', 'psd', 'doc', 'docx', 'xls', 'xlsx', 'ttp', 'ttpx', 'txt'];
            this.uploadSizeLimitExcel = 1000000000;
            this.enableExtensionsExcel = ['xls', 'xlsx'];
            this.ext = 'jpg';
            var self = this;
            ...
            // フェイクのファイル選択ボタン
            $('.trigAjaxingUploadingBtn').click(function () {
         ...
         * @return boolean
         */
        MyUpload.prototype.checkUploadFile = function (files, type) {
            var result = true;
            var errorMessage = "";
            if (files.length == 0) {
                result = false;
                ...
                files = files[0];
                this.ext = func_1.default.getExtention(files.name);
                var extensions = [];
                var limit = 0;
                if (type == "image") {
                ...
                if (!func_1.default.inArray(this.ext, extensions)) {
                    result = false;
                    errorMessage = "\"" + this.ext + "\" is invalid!\n使用できる拡張子は " + extensions.join("、") + " です";
                }
                else if (files.size > limit) {
                    result = false;
                    errorMessage = "FIle size \"" + func_1.default.unitFormat(files.size) + "\" is too large!\nファイルサイズは " + func_1.default.unitFormat(limit) + " 以内にして下さい";
                }
            }
         ...
         * @return boolean
         */
        MyUpload.prototype.uploadFile = function (files, type, target) {
            var fd = new FormData();
